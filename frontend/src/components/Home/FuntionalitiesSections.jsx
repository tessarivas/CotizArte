...
export const FuncionalitiesSection = () => {
  ...
  const Card = ({ src, alt, rotate, index }) => (
    <motion.div
      ...
      className="w-[240px] lg:w[240px] xl:w-[280px] 2xl:w-[320px] bg-white/60 p-4 xl:p-5 rounded-field shadow-xl"
    >
      <img
        src={src}
        alt={alt}
  ...
  return (
    <div className="relative h-screen w-full snap-start bg-gradient-to-b from-orange-200 via-pink-200 to-teal-200 flex items-center justify-center p-4 lg:p-8">
      ...
      <img
        ...
        alt="Acuarela Azul"
        className="absolute top-[10%] lg:top-[25%] left-[20%] lg:left-[30%] w-[45%] lg:w-[37%] rotate-120 opacity-50 mix-blend-lighten z-0"
      />
      <img
        src="/Acuarela Naranja.webp"
        alt="Acuarela Naranja"
        className="absolute top-[15%] lg:top-[25%] right-[5%] lg:right-[5%] w-[45%] lg:w-[35%] rotate-35 opacity-80 mix-blend-lighten z-0"
      />
      <img
        src="/Acuarela Rosa.webp"
        alt="Acuarela Rosa"
        className="absolute top-[20%] lg:top-[25%] left-[2%] lg:left-[5%] w-[45%] lg:w-[35%] rotate-70 opacity-100 mix-blend-lighten z-0"
      />
      ...
      <img
        ...
        className="absolute top-[15%] left-[20%] lg:left-[5%] lg:top-[20%] w-4 lg:w-6 h-4 lg:h-6 opacity-80 animate-sparkle z-10"
      />

      <img
        src="/Sparkle.svg"
        alt="Efecto de Brillo"
        className="absolute top-[25%] lg:top-[15%] right-[10%] lg:right-[5%] w-5 lg:w-8 h-5 lg:h-8 opacity-80 animate-sparkle z-10"
      />

      <img
        src="/Sparkle.svg"
        alt="Efecto de Brillo"
        className="absolute top-[55%] lg:top-[60%] left-[10%] lg:left-[45%] w-4 lg:w-5 h-4 lg:h-5 opacity-80 animate-sparkle z-10"
      />

      <img
        src="/Sparkle.svg"
        alt="Efecto de Brillo"
        className="absolute top-[60%] lg:top-[85%] right-[25%] lg:right-[30%] w-5 lg:w-7 h-5 lg:h-7 opacity-80 animate-sparkle z-10"
      />

      <img
        src="/Sparkle.svg"
        alt="Efecto de Brillo"
        className="absolute bottom-[10%] lg:top-[90%] right-[60%] lg:right-[10%] w-4 lg:w-5 h-4 lg:h-5 opacity-80 animate-sparkle z-10"
      />
