  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-b from-teal-200 via-pink-200 to-orange-200">
      <form
        ...
        className="bg-white shadow-lg rounded-box px-8 py-8 max-w-md w-[22vw]"
      >
        {/* Título con efecto */}
        <SparklesText
        ...
        <div className="mb-4">
          <label
            className="block text-base-content text-sm font-bold mb-2 font-regular-text"
            htmlFor="email"
          >
            Correo Electrónico:
          </label>
        ...
        {errorMessage && (
          <p className="text-error text-sm text-center mt-2">{errorMessage}</p>
        )}
